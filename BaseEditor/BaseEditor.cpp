...
{
    QString fileName = QFileDialog::getSaveFileName(this, tr("Save DB"),"", tr("Data Base Dvoryaninov (*.dpv);;All Files(*)"));
    bool ok;
    if (fileName.isEmpty())
        return;
    else
    {
        ...
        std::u16string header = u"Dvoryaninov";
...
{
    QString fileName = QFileDialog::getOpenFileName(this,tr("Open DB"),"", tr("Data Base Dvoryaninov (*.dpv);;All Files(*)"));
	if (fileName.isEmpty())
		return;
	else
	{
